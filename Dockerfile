...
RUN pip install gradio==3.50.2 langid faster-whisper whisper-timestamped unidecode eng-to-ipa pypinyin cn2an fastapi uvicorn torch[torchvision] torch[extra]
...
CMD ["sh", "-c", "uvicorn openvoice.api:app --host 0.0.0.0 --port 8000 & python3 -m openvoice_app --share"]
